...
if __name__ == '__main__':
    ...
    target_size = None  # maximum(height, width)

    # model_id_o = '20170319_011751'
    # model_id_o = '20170326_213631'
    # model_id_o = '20170327_171607'
    # model_id_o = '20170319_111548'
    # model_id_o = '20170326_230144'
    ...
    base_out_dir = os.path.join(
        base_dir,
        'prediction.resize_h_w_max_{}'.format(target_size),
