...
if __name__ == '__main__':
    ...
    # model_id_fill = ('20170709_161154', 1)  # conv6 rf3
    # model_id_fill = ('20170708_073900', 2)  # conv6 rf3
    # model_id_fill = ('20170708_154229', 4)  # conv6 rf3
    # model_id_fill = ('20170711_080438', 8)  # conv6 rf3
    # model_id_fill = ('20170711_175508', 16)  # conv6 rf3

    # model_id_fill = ('20170713_153618', 4)  # 0.1 threshold
    # model_id_fill = ('20170717_104045', 4)  # 0.3 threshold
    # model_id_fill = ('20170713_002039', 4)  # 0.5 threshold
    # model_id_fill = ('20170717_103859', 4)  # 0.7 threshold
    # model_id_fill = ('20170713_055026', 4)  # 0.9 threshold

    # model_id_fill = ('20170713_224322', 4)  # 0.5 threshold with instrument mask

    # model_id_fill = ('20170715_132759', 4)  # inst*audio as target v1, 0.1
    # model_id_fill = ('20170714_144445', 4)  # inst*audio as target v1, 0.2
    # model_id_fill = ('20170715_232957', 4)  # inst*audio as target v1, 0.3
    # model_id_fill = ('20170716_085223', 4)  # inst*audio as target v1, 0.4
    # model_id_fill = ('20170715_132615', 4)  # inst*audio as target v1, 0.5
    # model_id_fill = ('20170716_185749', 4)  # inst*audio as target v1, 0.6
    # model_id_fill = ('20170716_085231', 4)  # inst*audio as target v1, 0.7
    # model_id_fill = ('20170716_185757', 4)  # inst*audio as target v1, 0.8
    # model_id_fill = ('20170715_233010', 4)  # inst*audio as target v1, 0.9

    # model_id_fill = ('20170714_155252', 4)  # inst*audio as target v2
    # model_id_fill = ('20170715_004352', 4)  # inst*audio as target v3

    # model_id_fill = ('20170722_002530', 4)  # inst as target 0.1 thres
    # model_id_fill = ('20170719_155122', 4)  # inst as target 0.3 thres
    # model_id_fill = ('20170722_002420', 4)  # inst as target 0.5 thres
    # model_id_fill = ('20170722_105620', 4)  # inst as target 0.7 thres
    model_id_fill = ('20170722_105631', 4)  # inst as target 0.9 thres

    # model_id_fill = ('20170720_113125', 4)  # Audio model with YT8M 0.5 thres
    # model_id_fill = ('20170720_113612', 4)  # Audio model with Magna 0.5 thres
    # model_id_fill = ('20170720_205529', 4)  # Audio model with Magna 0.3 thres
    # model_id_fill = ('20170720_232406', 4)  # Audio model with Magna 0.1 thres
