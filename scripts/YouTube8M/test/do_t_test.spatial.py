...
if __name__ == '__main__':
    ...
    # model_id_1 = '20170713_002039__20170710_211725'
    # model_id_2 = '20170714_144445__20170710_211725'
    ...
    base_in_dir_1 = os.path.join(
        base_dir,
        'test_result.video_wise.spatial.bilinear', param_type, model_id_1)

    base_in_dir_2 = os.path.join(
        base_dir,
        'test_result.video_wise.spatial.bilinear', param_type, model_id_2)
