...
if __name__ == '__main__':
    ...
    # model_id = '20170321_095554'  # merge with conv
    # model_id = '20170320_230631'  # mul before pool, freeze image net
    model_id = '20170324_100227'  # mul before pool, no freeze
    ...
    base_pred_dir = os.path.join(
        base_dir,
        'prediction.joint.{}_{}.fragment_{}s'.format(
