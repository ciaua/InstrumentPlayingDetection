...
def do_one(args):
    fn, in_feat_dir, out_feat_dir, func_pr = args
...
def make_structure(scaler_list):
    network_list = list()
    input_var_list = list()
...
if __name__ == '__main__':
    ...
    out_feat_type = 'temporal_instrument'
    sr = 16000
    win_size = 2048
    hop_size = 512
    num_mels = 128
    ...
    input_var_list, network, frame_output_layer = make_structure([scaler])
    ...
    args_list = list()
    for fn in fn_list:
        args = (fn, in_feat_dir, out_feat_dir, func_pr)
