...
if __name__ == '__main__':
    ...
    # audio anno info
    audio_model_id = '20170710_110230'  # 16 frames per seg, pool [4, 4]
    ...
    out_dir = os.path.join(
        ...
        'audioanno_feats_inst.audio_{}.inst_{}.{}.fill_{}.plus128'.format(
            audio_model_id, inst_model_id, base_feat_type, fill_factor))
    ...
    for phase in ['tr', 'va', 'te']:
        ...
        for ii, _id in enumerate(id_list):
            ...
            for fn in fn_list:
                ...
                exist_list = map(os.path.exists,
                                 [audioanno_fp, feat_fp, inst_fp])
                all_good = all(exist_list)

                if all_good:
                    # print('Valid: {}'.format(sn))
                    out_fp_list.append([audioanno_fp, feat_fp, inst_fp])
                else:
