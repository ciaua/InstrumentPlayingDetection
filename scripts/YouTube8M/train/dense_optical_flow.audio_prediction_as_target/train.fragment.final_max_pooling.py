...
def validate(net, X_va_list, y_va, threshold, measure_func):
...
def test(net, X_te_list, y_te, threshold, measure_func):
...
if __name__ == '__main__':
    ...
    # audio_model_id = '20170710_110230'  # 256 filters
    # audio_model_id = '20170727_202434'  # 128 filters
    # audio_model_id = '20170718_091515'  # 64 filters
    # audio_model_id = '20170710_164755'  # 32 filters
    # audio_model_id = '20170727_202559'  # 16 filters
    # audio_model_id = '20170728_160936'  # 8 filters
    # audio_model_id = '20170728_103132'  # 4 filters
    # audio_model_id = '20170728_160946'  # 2 filters
    audio_model_id = '20170728_103124'  # 1 filters
    ...
    anno_feats_dir = os.path.join(
        ...
        'audioanno_feats.audio_{}.{}.fill_{}.plus128'.format(
            audio_model_id, feat_type, fill_factor))
    ...
    # manager_fp = os.path.join(output_dir, 'manager.pkl')
    ...
    utils.load_model(base_param_fp, net, device_id=gid)
    ...
    for epoch in range(start_epoch, 1+num_epochs):
        ...
        score_va, mean_loss_va = validate(
            net, X_va_list, y_va, threshold, measure_func)

        # ### Testing ###
        print('')
        print('Testing...')
        score_te = test(net, X_te_list, y_te, threshold, measure_func)
