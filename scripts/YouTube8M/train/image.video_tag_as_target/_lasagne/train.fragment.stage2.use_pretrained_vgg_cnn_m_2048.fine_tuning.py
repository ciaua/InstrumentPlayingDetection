...
if __name__ == '__main__':
    ...
    pretrained_model_id = '20170319_002822'
    pretrained_param_type = 'best_measure'
    ...
    pretrained_param_fp = os.path.join(
        save_dir, pretrained_model_id, 'model',
        'params.{}.npz'.format(pretrained_param_type))
    ...
    utils.load_model(pretrained_param_fp, network)
