...
if __name__ == '__main__':
    ...
    # pretrained models
    model_id_i = '20170319_085641'  # instrument model

    # threshold_str = '09'  # 0.9
    threshold_str = '07'  # 0.7
    # threshold_str = '05'  # 0.5
    # threshold_str = '03'  # 0.3
    # threshold_str = '01'  # 0.1

    # model_id_o = '20170415_192347'  # action model: threshold 0.9
    model_id_o = '20170415_192250'  # action model: threshold 0.7
    # model_id_o = '20170403_183041'  # action model: threshold 0.5
    # model_id_o = '20170413_214203'  # action model: threshold 0.3
    # model_id_o = '20170413_224330'  # action model: threshold 0.1
    ...
    feat_type = 'image_and_dense_optical_flow'
    ...
    anno_feats_dir = os.path.join(
        ...
        'audioanno_feats.threshold_{}.{}.{}.plus127'.format(
            threshold_str, audioanno_model_id, feat_type))
    ...
    network_i = net_i_dict['conv8']
    # network_i = net_i_dict['pooled_output']

    net_o_dict = make_structure_optical_flow(input_var_o, num_tags)
    network_o = net_o_dict['conv8']
    # network_o = net_o_dict['pooled_output']
    ...
    utils.load_model(param_o_fp, network_o)

    # Merge two networks
    merged_network = ElemwiseMergeLayer([network_i, network_o],
                                        T.mul,
