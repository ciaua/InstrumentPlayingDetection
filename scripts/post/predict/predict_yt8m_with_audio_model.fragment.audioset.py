...
class Net(nn.Module):
    def __init__(self, num_labels, feat_dim, scaler_list, num_early_filters):
...
if __name__ == '__main__':
    ...
    # model_id = '20170710_110230'  # 256 filters, 16 frames per seg, pool 4
    # model_id = '20170727_202434'  # 128 filters
    # model_id = '20170718_091515'  # 64 filters
    # model_id = '20170710_164755'  # 32 filters
    # model_id = '20170727_202559'  # 16 filters
    # model_id = '20170728_160936'  # 8 filters
    # model_id = '20170728_103132'  # 4 filters
    # model_id = '20170728_160946'  # 2 filters
    model_id = '20170728_103124'  # 1 filters
    ...
    scaler_dir_list = [
        os.path.join(audio_data_dir,
                     'exp_data_common.audio.target_time.5000',
    ...
    # make net
    net = Net(num_labels, feat_dim, scaler_list, num_early_filters)
    net.eval()
    net.cuda()
